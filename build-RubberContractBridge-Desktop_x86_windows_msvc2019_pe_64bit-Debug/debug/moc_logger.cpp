...
#include <memory>
#include "../../RubberContractBridge/logger.h"
...
QT_MOC_LITERAL(3, 16, 7), // "context"
QT_MOC_LITERAL(4, 24, 3), // "msg"
QT_MOC_LITERAL(5, 28, 3) // "log"

    },
    "Logger\0sendLog\0\0context\0msg\0log"
};
...
void Logger::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Logger::*)(QString , QString ) const;
...
// SIGNAL 0
void Logger::sendLog(QString _t1, QString _t2)const
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))), const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t2))) };
    QMetaObject::activate(const_cast< Logger *>(this), &staticMetaObject, 0, _a);
}
QT_WARNING_POP
