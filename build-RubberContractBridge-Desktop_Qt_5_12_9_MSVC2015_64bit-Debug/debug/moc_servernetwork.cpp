...
#include "../../RubberContractBridge/network/servernetwork.h"
...
QT_MOC_LITERAL(1, 14, 12), // "playerJoined"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 10), // "playerName"
QT_MOC_LITERAL(4, 39, 18), // "playerDisconnected"
QT_MOC_LITERAL(5, 58, 13), // "connectClient"
QT_MOC_LITERAL(6, 72, 16) // "disconnectClient"

    },
    "ServerNetwork\0playerJoined\0\0playerName\0"
    "playerDisconnected\0connectClient\0"
    "disconnectClient"
};
...
void ServerNetwork::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->playerJoined((*reinterpret_cast< QString(*)>(_a[1]))); break;
        ...
        {
            using _t = void (ServerNetwork::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ServerNetwork::playerJoined)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (ServerNetwork::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ServerNetwork::playerDisconnected)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void ServerNetwork::playerJoined(QString _t1)
{
...
// SIGNAL 1
void ServerNetwork::playerDisconnected(QString _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
